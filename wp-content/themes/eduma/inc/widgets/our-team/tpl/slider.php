...
if ( $our_team->have_posts() ) {
	...
	while ( $our_team->have_posts() ): $our_team->the_post();
		...
		$html .= '<div class="our-team-image"> ' . thim_get_feature_image( get_post_thumbnail_id(), 'full', apply_filters( 'thim_member_thumbnail_width', 200 ), apply_filters( 'thim_member_thumbnail_height', 200 ) );
