...
<div id="lp-profile-edit-password-form">
	<ul class="lp-form-field-wrap">
		...
		<li class="lp-form-field">
			<label class="lp-form-field-label"><?php _e( 'Old password', 'eduma' ); ?></label>
		...
		<li class="lp-form-field">
			<label class="lp-form-field-label"><?php _e( 'New password', 'eduma' ); ?></label>
			<div class="lp-form-field-input">
				<input type="password" name="pass1" id="pass1" class="regular-text" value="" />
			</div>
		</li>
		<li class="lp-form-field">
			<label class="lp-form-field-label"><?php _e( 'Confirmation password', 'eduma' ); ?></label>
			<div class="lp-form-field-input">
				<input name="pass2" type="password" id="pass2" class="regular-text" value="" />
				<p id="lp-password-not-match" class="description lp-field-error-message hide-if-js"><?php _e( 'New password does not match!', 'eduma' ); ?></p>
			</div>
		</li>
