...
class WPEMS_Custom_Post_Types {
	...
	public function __construct() {
		...
		$view = get_the_terms( '165', $taxonomy );
	...
	public function register_event_category_tax() {
		...
		$labels = array(
			'name'              => _x( 'Teachers', 'taxonomy general name', 'wp-events-manager' ),
			'singular_name'     => _x( 'Teacher', 'taxonomy singular name', 'wp-events-manager' ),
			'search_items'      => __( 'Search Teachers', 'wp-events-manager' ),
			'all_items'         => __( 'All Teachers', 'wp-events-manager' ),
			'parent_item'       => __( 'Add Teacher', 'wp-events-manager' ),
			'parent_item_colon' => __( 'Add Teacher:', 'wp-events-manager' ),
			'edit_item'         => __( 'Edit Teacher', 'wp-events-manager' ),
			'update_item'       => __( 'Update Teacher', 'wp-events-manager' ),
			'add_new_item'      => __( 'Add New Teacher', 'wp-events-manager' ),
			'new_item_name'     => __( 'New Teacher Name', 'wp-events-manager' ),
			'menu_name'         => __( 'Teacher', 'wp-events-manager' ),
		);
